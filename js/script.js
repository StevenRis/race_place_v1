...
window.addEventListener('DOMContentLoaded', () => {
  ...
  async function createCarCard() {
    try {
      ...
      db.forEach((car) => {
        ...
        tree.append(carCard);
        ///
        let carCardSetups = document.querySelectorAll('.car-card__setups');
        ...
        test.appendChild(stp);
        ///
        car.setup.forEach((setup) => {
          const e = document.createElement('div');
          e.classList.add('setup-country__item');
          e.innerHTML = `
        ...
        setupsParent = document.querySelectorAll('.setups');
        setupCountry = document.querySelectorAll('.setup-country');
        s = document.querySelectorAll('.setup-country__item');
        console.log(s);
  ...
  function openSetups(item) {
    setupCountry[item].classList.add('selected');
